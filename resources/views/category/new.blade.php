<div class="modal fade" id="category-new" tabindex="-1" aria-labelledby="category-label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" onsubmit="category.new(this); return false">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="category-label">Kategori Ekle</h1>
