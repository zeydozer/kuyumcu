<div class="modal fade usr-modal" id="user-new" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" onsubmit="user.new(this); return false">
      <div class="modal-header">
        <h1 class="modal-title">Kullanıcı Ekle</h1>
      ...
      <div class="modal-body">
        @if ($user->admin)
          ...
          <div class="form-check admin mb-4" style="display: none">
            ...
            <label class="form-check-label" for="new-admin">Admin yetkisi ver</label>
          </div>
        @else
        ...
        <label class="usr-field">
          <span>Şifre</span>
          <input type="password" class="form-control" name="pass" placeholder="Şifre belirleyin" required>
        </label>
        <label class="usr-field">
          <span>Telefon</span>
