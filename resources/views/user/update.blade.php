<div class="modal fade" id="user-update" tabindex="-1" aria-labelledby="user-label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" onsubmit="user.update(this); return false">
      <input type="hidden" name="id">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="user-label">Kullanıcı Düzenle</h1>
      ...
      <div class="modal-body">
        ...
        <div class="input-group mb-3">
          ...
          <input type="password" class="form-control" name="pass" placeholder="Yeni Şifre">
        </div>
        <div class="input-group mb-3">
